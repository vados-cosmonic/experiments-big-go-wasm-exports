...
// Package terminaloutput represents the imported interface "wasi:cli/terminal-output@0.2.4".
//
// Terminal output.
//
...
// TerminalOutput represents the imported resource "wasi:cli/terminal-output@0.2.4#terminal-output".
//
