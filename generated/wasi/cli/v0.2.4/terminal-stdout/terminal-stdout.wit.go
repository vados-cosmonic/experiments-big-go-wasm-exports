...
// Package terminalstdout represents the imported interface "wasi:cli/terminal-stdout@0.2.4".
//
...
// TerminalOutput represents the imported type alias "wasi:cli/terminal-stdout@0.2.4#terminal-output".
//
